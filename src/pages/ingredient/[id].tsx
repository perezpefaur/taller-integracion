        ...
        <>
          <div className="my-36 mx-10 lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
            ...
            <div className="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
              ...
              <p className="mt-6 text-gray-500">{ingredient.description}</p>
              ...
              <div className="mt-10 border-t border-gray-200 pt-10">
                ...
                <p className="mt-4 text-sm text-gray-500">
                  <p className="mt-2 text-sm text-gray-500">
                    Precio: {formatCurrency(ingredient.price)}{' '}
                  </p>
                  <p className="mt-2 text-sm text-gray-500">
                    Peso: {ingredient.size} gr
                  </p>
                  <p className="mt-2 text-sm text-gray-500">
                    Expiración: {ingredient.expiration}{' '}
                  </p>
                </p>
              </div>
            </div>
