...
const Ingredients = () => {
  ...
  useEffect(() => {
    fetch(
      `https://tarea-1.2023-1.tallerdeintegracion.cl/ingredients?sort=${sortBy}&order=${order}&page=${page}&size=10`,
      {
        headers: {
    ...
    >
      <div>
        ...
        <div className="shadow sm:hidden">
          ...
          >
            {menus.map((menu: IIngredientGeneral) => (
              <li key={menu.id}>
                <a
